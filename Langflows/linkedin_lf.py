...
def analyze_engagement(data):
    data['engagement_rate'] = (data['likes'] + data['comments'] + data['shares']) / data['followers'] * 100
    return data
...
result = flow.run({"file_path": "path_to_linkedin_scraped_data.csv"})
